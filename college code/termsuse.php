...
<p>The College Code website located at http://www.collegecode.in is a copyrighted work belonging to College code. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
...
<p><strong>Cookies and Web Beacons.</strong> Like any other website, College Code uses ‘cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
...
<p>Address: Agra,Uttar Pradesh,india</p>
<p>Email: www.collegecode2509@gmail.com</p>
</body>
</html>